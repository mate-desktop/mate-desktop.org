...
on Arch Linux from the following wiki page:
  ...
  * [https://wiki.mate-desktop.org/#!pages/./archlinux_custom_repo.md](https://wiki.mate-desktop.org/#!pages/./archlinux_custom_repo.md)
...
with that by voting for MATE packages in the AUR.
  ...
  * [https://aur.archlinux.org/packages/?SeB=m&K=flexiondotorg](https://aur.archlinux.org/packages/?SeB=m&K=flexiondotorg)
