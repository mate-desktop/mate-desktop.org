...
de MATE desktop omgeving is helemaal gratis en alle betrokkenen zijn vrijwilligers

Denk er eens over na om aan het MATE project te doneren. Het is fijn om al de moeite
die erin is gestoken te erkennen. Al het opgehaalde geld wordt gebruikt om hosting,
harware en mogelijke reiskosten te betalen, zodat MATE team members relevente
conferenties kunnen bijwonen.

We vragen om niet veel, jou de keuze.
...
We hebben liever dat je een maandelijkse betaling uitvoert. Zo zijn wij zeker dat we
onze maandelijkse kosten kunnen drukken en zo kunnen we beter plannen hoe we onze
vrijwilligers kunnen verrijken of andere Open Source Projecten kunnen steunen.
...
<div class="bs-docs-section">
  <div class="well">
    <form name="monthly" class="form-horizontal" action="https://www.paypal.com/cgi-bin/webscr" onsubmit="return validateMonthlyForm()" method="post">
      <fieldset>
        <legend>Maandelijkse PayPal supporter</legend>
        <div class="row">
        ...
        <div class="row">
          <label for="monthly-specifyAmount" class="control-label">Kies je eigen waarde</label>
        ...
        <button type="submit" class="btn btn-primary">Maandelijkse Donatie</button>
      </fieldset>
  ...
  <div class="well">
    <form name="single" class="form-horizontal" action="https://www.paypal.com/cgi-bin/webscr" onsubmit="return validateSingleForm()" method="post">
      <fieldset>
        ...
        <div class="row">
          <label class="control-label">Kies een waarde</label>
          <label class="badge badge-info btn-mini"><input type="radio" name="amt" value="5">5</label>
          <label class="badge badge-success btn-mini"><input type="radio" name="amt" value="10" checked>10</label>
          <label class="badge badge-warning btn-mini"><input type="radio" name="amt" value="25">25</label>
          <label class="badge badge-important btn-mini"><input type="radio" name="amt" value="50">50</label>
        ...
        <div class="row">
          <label for="one-time-specifyAmount" class="control-label">Specifier je eigen waarde</label>
        ...
        <button type="submit" class="btn btn-primary">eenmalige Donatie</button>
      </fieldset>
...
<div class="bs-docs-section">
  <div class="well">
    <fieldset>
      ...
      <p>klik of scan de onderstaande QR code in je bitcoin client en doneer
      0.02 btc aan MATE Desktop. Je kan ook het bitcoin adres kopieren in je
      bitcoin client om een eigen waarde te doneren.</p>
      <p align="center">
    ...
    var n = document.forms["monthly"]["other"].value;
      if (n) {
        if (!isNaN(parseFloat(n)) && isFinite(n) && (n > 0)) {
          ...
          alert("Vul een geldige waarde in - bedankt!");
