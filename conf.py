...
# "disqus", "livefyre", "intensedebate", "moot", "googleplus" or "facebook"
...
<span class="navbar-search pull-right">
    <input class="input-medium search-query search-margin" type="search" placeholder="Search" id="tipue_search_input"></inpu$
</span>"""
